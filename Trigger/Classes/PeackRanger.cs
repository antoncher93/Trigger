...
{
    public class PeakRanger : IRanger
    {
        ...
        {
            if ((_secondLineInfo.RssiPeak - _firstLineInfo.RssiPeak)>=TimeSpan.FromMilliseconds(1000))
            {
                ...
                OnEvent?.Invoke(this, new TriggerEventArgs
                {
                    ...
                    SpaceUid = _spaceUid,
                    UserId = _userUid,
                    Timespan = _secondLineInfo.RssiPeak.Time
                });
            }
